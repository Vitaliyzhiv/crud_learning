...
<body>
    ...
    <div class="container mt-5">
        <div class="row mb-3">
            <div class="col-6">
                <a href="http://localhost/users-phones.php" class="btn btn-outline-primary w-100">Watch users phones
                    table</a>

                <h2 class="mt-2"> Users phones </h2>
            ...
            <div class="col-6">
                <a href="http://localhost/users-emails.php" class="btn btn-outline-primary w-100">Watch user emails
                    table</a>

                <h2 class="mt-2"> Users mails </h2>
                <form action="form.php" method="post">
